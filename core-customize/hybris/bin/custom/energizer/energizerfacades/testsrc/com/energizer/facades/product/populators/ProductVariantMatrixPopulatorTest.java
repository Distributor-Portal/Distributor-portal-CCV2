...
public class ProductVariantMatrixPopulatorTest
{
	...
	protected static final Logger LOG = Logger.getLogger(ProductVariantMatrixPopulatorTest.class);
	...
	public void shouldPopulateNDimension()
	{
		...
		for (int dimension = 0; dimension < dimensions.length; dimension++)
		{
			...
			LOG.info("Processing Variant:" + variant.getCode() + " - Dimension: " + dimension);
