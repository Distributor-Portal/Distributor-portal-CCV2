...
{
	//console.log('csrfToken : ' + $('#csrfToken').val());      
	
	var escapeCSRFForDeliveryNotes = $('#escapeCSRFForDeliveryNotes').val();
	//console.log('escapeCSRFForDeliveryNotes : ' + $('#escapeCSRFForDeliveryNotes').val());  
	
	if(null == escapeCSRFForDeliveryNotes || undefined == escapeCSRFForDeliveryNotes || escapeCSRFForDeliveryNotes != 'true'){
