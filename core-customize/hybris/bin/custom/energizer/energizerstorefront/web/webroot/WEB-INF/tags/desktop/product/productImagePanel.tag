...
<div class="span-14 productImage">
	...
	<div class="productImagePrimary" id="primary_image">
		...
		<!-- Added condition as code changes for WeSell Implementation - To hide images for WeSell  - START -->
		...
		<!-- Added condition as code changes for WeSell Implementation - To hide images for WeSell  - END -->
