	...
	<div class="item_container_holder">
		...
		<c:if test="${ empty forgotPwdConfMsgs}">
			<div class="title_holder">
				<h2>
					<spring:theme code="confirmAccount.title" />
				</h2>
			</div>
			<div class="item_container">
				<p>
					<spring:theme code="confirmAccount.description" />
				</p>
				<%-- <p class="required">
					<spring:theme code="form.required" />
				</p> --%>
				<form:form method="post" modelAttribute="confirmAccountForm">
			  						 ...
			  						 <c:choose>
			  						 	...
			  						 	<c:otherwise>
											...
											<button class="positive" type="submit">
												<spring:theme code="confirmAccount.submit" />
											</button>
