...
<form:form method="post" modelAttribute="paymentDetailsForm" action="${createUpdatePaymentUrl}" class="create_update_payment_form ${not empty createUpdateStatus ? createUpdateStatus : ''}" >
