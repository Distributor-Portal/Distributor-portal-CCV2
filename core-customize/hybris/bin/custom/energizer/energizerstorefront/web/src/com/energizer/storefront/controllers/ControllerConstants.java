...
public interface ControllerConstants
{
	...
	interface Views
	{
		...
		interface Pages
		{
			...
			interface footer
			{
				String FooterHomePage = "pages/footer/footerHomePage";
			}
		}
		...
		interface Fragments
		{
			...
			interface Account
			{
				String UnlockAccountRequestPage = "fragments/account/unlockAccountRequestPage";
				String confirmAccountRequestPage = "fragments/account/confirmAccountRequestPage";
			}
		}
	}
}
